  ...
  return (
    <div className="flex items-center justify-center mt-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-20 p-6">
        {/* Card 1 */}
        <div className="border rounded-lg p-6 text-center bg-gray-600 shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <h2 className="text-3xl text-red-100 font-bold p-2">60+</h2>
          <p className="text-amber-500 uppercase text-xl font-semibold">Successful Projects</p>
        </div>
        ...
        <div className="border rounded-lg p-6 text-center bg-gray-600 shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <h2 className="text-3xl text-red-100 font-bold p-2">24*7</h2>
          <p className="text-amber-500 uppercase text-xl font-semibold">Customer Support</p>
        </div>
      </div>
    </div>
  );
